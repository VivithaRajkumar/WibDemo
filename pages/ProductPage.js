...
//     await this.driver.findElement(By.id("termsofservice")).click();
//     await this.driver.findElement(By.id("checkout")).click();

//     // Fill billing details
//     await this.driver.findElement(By.id("BillingNewAddress_City")).sendKeys("TestCity");
//     await this.driver.findElement(By.id("BillingNewAddress_Address1")).sendKeys("Test Address");
//     await this.driver.findElement(By.id("BillingNewAddress_ZipPostalCode")).sendKeys("12345");
//     await this.driver.findElement(By.id("BillingNewAddress_PhoneNumber")).sendKeys("1234567890");
//     await this.driver.findElement(By.css("button[name='save']")).click();

//     // Continue shipping & payment
//     await this.driver.findElement(By.css("button[name='save']")).click();
//     await this.driver.findElement(By.css("button[name='confirm']")).click();
    
//   }

  async getOrderConfirmation() {
    const confirmationLocator = By.css("div.title strong");
    await this.driver.wait(until.elementLocated(confirmationLocator), 10000);
    return await this.driver.findElement(confirmationLocator).getText();
  }
}
